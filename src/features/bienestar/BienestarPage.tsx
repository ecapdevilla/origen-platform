  ...
  return (
    <div className="space-y-6">
      <section className="overflow-hidden rounded-[2rem] border border-surface-800 bg-surface-950 p-6 text-white shadow-[0_20px_70px_-25px_rgba(28,25,23,0.35)] sm:p-8">
        <p className="text-sm text-surface-300">Módulo Bienestar</p>
      ...
      <section className="grid gap-6 xl:grid-cols-[420px_1fr]">
        <div className="rounded-[2rem] border border-surface-200 bg-white p-5 shadow-sm sm:p-6">
          ...
          <form onSubmit={handleSubmit} className="mt-6 grid gap-4">
            ...
            <label className="block">
              <span className="text-sm font-bold text-surface-700">Estado de ánimo</span>
              <select
            ...
            <label className="block">
              <span className="text-sm font-bold text-surface-700">Nota</span>
              <textarea
                value={form.nota}
                ...
                className="mt-1 min-h-32 w-full rounded-2xl border border-surface-200 px-4 py-3 outline-none transition focus:border-brand-600"
              />
            </label>
          ...
          <section className="rounded-[2rem] border border-surface-200 bg-white p-5 shadow-sm sm:p-6">
            ...
            <div className="mt-6 grid gap-4">
              {registrosFiltrados.map((registro) => {
                ...
                return (
                  <article key={registro.id} className="rounded-[2rem] border border-surface-200 p-5">
              ...
              {registrosFiltrados.length === 0 && (
                <div className="rounded-[2rem] border border-dashed border-surface-300 p-12 text-center">
                  <p className="font-black text-surface-700">No hay registros para mostrar</p>
                  <p className="mt-2 text-sm text-surface-500">
  ...
  return (
    <label className="block">
      ...
      <input
        ...
        className="mt-1 w-full rounded-2xl border border-surface-200 px-4 py-3 outline-none transition focus:border-brand-600"
      />
      {suffix && <span className="mt-1 block text-xs font-bold text-surface-400">{suffix}</span>}
    </label>
  )
}
