...
export function UsuariosPage({
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="mt-6 space-y-4">
            <Field label="Persona enlazada">
              <select
                ...
                className="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 outline-none focus:border-slate-950"
              >
                  ...
                  <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
                    ...
                    <div className="flex flex-col gap-2 sm:flex-row">
                      <button
                        ...
                        className="rounded-2xl bg-white px-4 py-3 text-sm font-black text-slate-700 shadow-sm hover:bg-slate-100"
                      >
                        Editar
                      </button>
      ...
      <section className="rounded-[2rem] bg-amber-50 p-6">
